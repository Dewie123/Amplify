...
const sampleBizFile = "https://mymailsimedu-my.sharepoint.com/:b:/r/personal/wmlim014_mymail_sim_edu_sg/Documents/A_FYP/Documents/BP(Biz)_SAMPLE.pdf?csf=1&web=1&e=PTQy7X";
