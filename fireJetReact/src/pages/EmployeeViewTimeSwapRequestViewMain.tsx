...
export default function EmployeeViewTimeSwapRequestViewMain({
  className = "",
}: EmployeeViewTimeSwapRequestViewMainProps) {
...
const navigate = useNavigate(); // Initialize useNavigate
  ...
  const handleViewReceivedTimeSwapRequests = () => {
              ...
              <div className="employee-view-time-swap-request-view-main-tt-view-attendance-record-button-view-attendance-record-button-tview-time-swap-request-view-time-swap-request" >
               ...
               <button
                ...
                <button
                  ...
                  onClick={handleViewReceivedTimeSwapRequests}
                >
                  View Received Time Swap Requests
                </button>
                <button
...
interface EmployeeViewTimeSwapRequestViewMainProps {
  className?: string;
}
